...
const Home = () => {
  return (
    <div>
      <div className="slider parallax" id="top">
        {/*<div className="fullscreen-video-wrap">*/}
          {/*<video src="video/bgrnd.webm" autoPlay loop></video>*/}
        {/*</div>*/}
        <div className="header-overlay"></div>
        <div className="header-content">
          <h1>BMW X<sub>7</sub></h1>
          <p>If you know about the existence of BMW,
            you are either the owner or you want to become one</p>
          <div id="discover-link">
            <a href='#scroll-section-a' className='playBut'>up
            </a>
          </div>
        </div>
      </div>
      <section id="scroll-section-a" className="section section-light">
        <div className="container">
          ...
          <p>Here everything is done for you: get acquainted with the new scale of luxury and sophistication
            in the concept of BMW X7 iPerformance. Its interior, marked by handmade art, offers the driver
            and passengers an outstanding comfort and incredible space. The combination of modern clear design,
            high-quality materials and the finest skin allows creating an atmosphere that perfectly corresponds
            to the grandeur and grandeur of the car.</p>
        </div>
      </section>
